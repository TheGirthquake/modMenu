...
namespace vMenuClient
{
    public class About
    {
        ...
        private void CreateMenu()
        {
            ...
            MenuItem credits = new MenuItem("About vMenu / Credits", "The Wilderness is made by ~b~Girthquake~s~. To join discord, go to ~b~https://discord.gg/8Buha9VTfx~s~. Thank you.");
